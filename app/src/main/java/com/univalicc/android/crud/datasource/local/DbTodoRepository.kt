...
class DbTodoRepository(private val context: Context) : TodoRepository {
                    ...
                    if (cursor != null)
                        if (cursor.moveToFirst()) {
                            ...
                            do {
                                ...
                                val nome = cursor.getString(cursor.getColumnIndex(COLUMN_TODO_NOME))
                                val telefone = cursor.getString(cursor.getColumnIndex(COLUMN_TODO_TELEFONE))
                                val tipo = cursor.getString(cursor.getColumnIndex(COLUMN_TODO_TIPO))
                                ...
                                todos.add(Todo(id, nome, telefone, tipo, completed, createdAt, updatedAt))
    ...
    override fun insert(todo: Todo): Long {
        ...
        try {
            appDbHelper.writableDatabase.use { db ->
                ...
                contentValues.put(COLUMN_TODO_NOME, todo.nome)
                contentValues.put(COLUMN_TODO_TELEFONE, todo.telefone)
                contentValues.put(COLUMN_TODO_TIPO, todo.tipo)
        ...
        try {
             ...
             */
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        todo = Todo(id, nome, telefone, tipo, isCompleted, createdAt, updatedAt)
                    }
                }
            }
        } catch (e: Exception) {
    ...
    companion object {
        ...
        const val COLUMN_TODO_NOME = "nome"
        const val COLUMN_TODO_TELEFONE = "telefone"
        const val COLUMN_TODO_TIPO = "tipo"
